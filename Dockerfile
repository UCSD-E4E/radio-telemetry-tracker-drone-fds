...
# Remove sudo from install.sh and execute
...
# Clone your main project (optional if already in build context)
# RUN git clone <your-repo> /workspace/radio-telemetry-tracker-drone-fds

# Set working directory to your main project
